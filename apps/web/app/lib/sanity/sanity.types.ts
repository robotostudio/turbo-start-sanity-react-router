...
// Variable: queryAllPagesDataForPrerender
// Query: *[_type in ["page", "blog","blogIndex","homePage"] && defined(slug.current)]{    "slug": slug.current,    "lastModified": _updatedAt  }
export type QueryAllPagesDataForPrerenderResult = Array<{
  slug: string;
  lastModified: string;
}>;
